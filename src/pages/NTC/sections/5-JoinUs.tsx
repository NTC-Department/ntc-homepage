  ...
  return (
    <div className="h-screen w-full relative flex items-center justify-center overflow-hidden">
      <div className="w-full max-w-[100rem] h-full flex flex-col px-4 sm:px-6 lg:px-0">
        ...
        <div className="h-[62%] sm:h-[55%] lg:h-[55%] gap-3 sm:gap-4 lg:gap-4 relative">
        ...
        <div className="h-[13%] sm:h-[14%] lg:h-[12%] flex items-center">
...
const CommunityCard = () => {
  return (
    <div className="h-64 sm:h-60 lg:h-[32.5rem] w-full relative">
