    ...
    <div className="h-full w-full">
      <div className="h-full flex flex-col">
        ...
        <div className="h-[35%] ps-20 flex justify-between">
          <span className="text-3xl font-bold border mt-auto mb-8 w-fit">OUR ARTIST</span>
...
const ImageCard = () => {
  return (
    <div className="h-56 flex flex-col">
      <img src={placeholderImage} className="w-full h-full object-cover rounded-t-sm" />

      {/* text: image description */}
      <div className="bg-black h-24 text-white z-10 py-2 px-4 flex gap-2 rounded-b-sm">
        <div className="flex items-center justify-center">
          {/* [placeholder] component: logo */}
          <span className="border rounded-full w-5 h-5 flex items-center justify-center">{">"}</span>
        </div>
        <div className="">
