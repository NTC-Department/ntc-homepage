...
import image1 from "@assets/content/Neogang/sections/4-OurArtist/image-1.png";
import image2 from "@assets/content/Neogang/sections/4-OurArtist/image-2.png";
import image3 from "@assets/content/Neogang/sections/4-OurArtist/image-3.png";
import logo2 from "@assets/content/Neogang/sections/4-OurArtist/logo-2.png";
import logo3 from "@assets/content/Neogang/sections/4-OurArtist/logo-3.png";
import logo4 from "@assets/content/Neogang/sections/4-OurArtist/logo-4.png";
      ...
      <div className="w-full max-w-[100%] h-full flex flex-col items-center">
        ...
        <div className="h-[27%] sm:h-[30%] lg:h-[28%] flex md:justify-between justify-center w-full max-w-[100rem] px-5 lg:px-20">
          <div className="mt-auto mb-10 lg:mb-12 h-12 sm:h-16 lg:h-20 flex items-center gap-2 sm:gap-3 lg:gap-4">
            <FaPlay className="w-4 h-4 lg:w-8 lg:h-8 lg:mt-2" />
            <h1 className="text-2xl sm:text-2xl lg:text-[3rem] font-bold">Our Artists</h1>
          </div>
...
export default OurArtistSection;
